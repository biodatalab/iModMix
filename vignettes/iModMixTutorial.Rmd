...
Upload partial correlaed matrix already calculates for Data 2 

```{r}
# Partial correlation
# parcorData2 <- partial_cors(load_data2, rho = 0.25) # Dont run this line. Take about ~10 min. 
# Plase upload partial correlation alreday calculated

path_parcorData2 <- system.file("Example_data/ccRCC4_Data/PartialCorGenes.rds", package = "iModMix")

# Load the expression data
parcorData2 <- readRDS(path_parcorData2)
```

Upload hierarchical clustering already calculates for Data 2

```{r}
# Perform hierarchical clustering 
# hcData2 <- hierarchical_cluster(parcor_mat = parcorData2, tom = TRUE, min_module_size = 10) # Dont run this line. 
# Plase upload phierarchical clustering alreday calculated

# Load the precomputed hierarchical clustering results
path_hcData2 <- system.file("Example_data/ccRCC4_Data/hcData2.rds", package = "iModMix")
# Load the expression data
hcData2 <- readRDS(path_hcData2)
...
Integration_Data1_Data2 <- Modules_correlation(eigengenes_list, cluster_list, threshold = 0.64)
