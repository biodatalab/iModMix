...
The dendrogram plot is publication-ready and display a dendrogram of features and modules. 
...
This step perform the integration of the datasets in the analysis. Is necessary list the eigenfuetues obtained from the previous steps. 
